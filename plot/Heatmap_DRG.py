...
exp_n = torch.load("../parameters/exp_n_drg_0.pt", map_location=device)
...
vocab_ids = pickle.load(open("../mapping/drg_vocab_ids.pkl", "rb")) # key is icd, value is the mapped index
